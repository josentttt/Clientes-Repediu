...
| Métrica                        | Resultado no Período (11/06 a 30/06)        |
| :----------------------------- | :------------------------------------------ |
| **Vendas (Conversões)**        | 38                                          |
| **Receita Total CRM**          | R$ 3.069,84                                 |
| **Mensagens Enviadas**         | 786                                         |
| **Clientes Recuperados**       | 26                                          |
| **Valor Gerado (Recuperados)** | R$ 2.342,51                                 |
| **Clientes Recorrentes**       | 12                                          |
| **Valor Gerado (Recorrentes)** | R$ 727,33                                   |
| **Participação na Receita**    | **8,12%** (Total da Loja: **R$ 37.825,82**) |
...
- **🟢 [N] Fidelização - +1 compra dentro de 30 dias** _(WhatsApp)_
    ...
    - **29/06 a 05/07/2026** → Receita: **R$ 249,86** | Conversões: **2** | Enviadas: **50** | Taxa: **4,00%**
        
    - **22/06 a 28/06/2026** → Receita: **R$ 145,97** | Conversões: **3** | Enviadas: **74** | Taxa: **4,05%**
...
- **🟢 [N] Recompra Rápida - 4 a 29 dias sem pedir** _(WhatsApp)_
    ...
    - **29/06 a 05/07/2026** → Receita: **R$ 196,87** | Conversões: **2** | Enviadas: **52** | Taxa: **3,85%**
        
    - **22/06 a 28/06/2026** → Receita: **R$ 978,28** | Conversões: **9** | Enviadas: **92** | Taxa: **9,78%**
...
- **🟢 [N] Rumo à Fidelização - 1 pedido entre 5 a 30 dias** _(WhatsApp)_
    ...
    - **29/06 a 05/07/2026** → Receita: **R$ 0,00** | Conversões: **0** | Enviadas: **48** | Taxa: **0,00%**
        
    - **22/06 a 28/06/2026** → Receita: **R$ 0,00** | Conversões: **0** | Enviadas: **13** | Taxa: **0,00%**
...
- Promissores: **297** (5,00%)
    
- Em risco: **2.694** (45,35%)
    
- Perdidos: **2.902** (48,85%)
...
- Promissores: **299** (5,10%)
    
- Em risco: **2.616** (44,58%)
    
- Perdidos: **2.901** (49,44%)
...
|:--|:--|:--|:--|
|**1ª → 2ª compra**|18,60%|951|18,60%|
|**2ª → 3ª compra**|42,80%|407|7,96%|
|**3ª → 4ª compra**|57,00%|232|4,54%|
|**4ª → 5ª compra**|59,48%|138|2,70%|
|**5ª → 6ª compra**|71,74%|99|1,94%|
|**6ª → 7ª compra**|79,80%|79|1,55%|
|**7ª → 8ª compra**|75,95%|60|1,17%|
|**8ª → 9ª compra**|80,00%|48|0,94%|
|**9ª → 10ª compra**|83,33%|40|0,78%|
...
- **13/07 a 19/07/2026**
    ...
    - Conversões (Pedidos): **8**
        
    - Mensagens Enviadas: **299**
        
    - Clientes Recuperados: **2**
        
    - Clientes Recorrentes: **6**
        
    - Participação na Receita: **6,89%** (Total da Loja: **R$ 12.021,50**)
        
- **06/07 a 12/07/2026**
    
    - Receita CRM: **R$ 958,00**
        
    - Conversões (Pedidos): **10**
        
    - Mensagens Enviadas: **290**
        
    - Clientes Recuperados: **4**
        
    - Clientes Recorrentes: **6**
        
    - Participação na Receita: **6,37%** (Total da Loja: **R$ 15.049,90**)
        
- **29/06 a 05/07/2026**
    
    - Receita CRM: **R$ 622,69**
        
    - Conversões (Pedidos): **6**
        
    - Mensagens Enviadas: **250**
        
    - Clientes Recuperados: **3**
        
    - Clientes Recorrentes: **3**
        
    - Participação na Receita: **6,79%** (Total da Loja: **R$ 9.167,96**)
        
- **22/06 a 28/06/2026**
    
    - Receita CRM: **R$ 1.421,70**
        
    - Conversões (Pedidos): **21**
        
    - Mensagens Enviadas: **297**
        
    - Clientes Recuperados: **4**
        
    - Clientes Recorrentes: **17**
        
    - Participação na Receita: **5,65%** (Total da Loja: **R$ 25.158,08**)
        
- **11/06 a 21/06/2026**
    
    - Receita CRM: **R$ 1.569,16**
        
    - Conversões (Pedidos): **16**
        
    - Mensagens Enviadas: **489**
        
    - Clientes Recuperados: **22**
        
    - Clientes Recorrentes: **16**
        
    - Participação na Receita: **14,40%** (Total da Loja: **R$ 10.895,91**)
...
- **22/07/2026:** Atualização semanal da operação.
    ...
    - **RFV:** A carteira manteve seu perfil característico com grande parte dos contatos nas faixas frias: **Em Risco (45,35%)** e **Perdidos (48,85%)**. A faixa de ativos conta com **1 Campeão (0,02%)**, **47 Fiéis (0,79%)** e **297 Promissores (5,00%)**.
        
- **13/07/2026:** Atualização semanal da operação.
    
    - **Desempenho Geral:** O CRM gerou **R$ 958,00** através de **10 conversões**, representando **6,37%** do faturamento da loja no período. Apesar da pequena redução de 0,43 ponto percentual na participação em relação à semana anterior, a operação apresentou crescimento no número de pedidos e aumento de receita, mantendo boa relevância dentro do faturamento da unidade.
...
- **05/07/2026:** Atualização semanal da operação.
    ...
    - **Acompanhamento:** Após o excelente desempenho obtido na semana anterior com a troca dos criativos, esta semana apresentou uma desaceleração natural no volume de conversões. Ainda assim, o CRM manteve participação relevante no faturamento da loja e continua gerando vendas de forma consistente, indicando estabilidade da operação.
        
- **03/07/2026:** Fechamento do primeiro ciclo do CRM (11/06 a 30/06).
